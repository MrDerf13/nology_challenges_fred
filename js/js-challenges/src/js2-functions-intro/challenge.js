 ...
 * @returns {number} 100
 */
export const findSmallestNumber = (/* Write the parameters here */number1, number2) => {
  /* Write your code here */
  if (number1 > number2) {
    return number2
  } else {
 ...
 * @returns {number} 18
 */
export const multiplyNumbers = (/* Write the parameters here */number1, number2) => {
  /* Write your code here */
...
export const getGrade = (score) => {
  /* Write your code here */
  if (typeof score !="number" || score==NaN || score>100 || score<0){
...
export const calculateAreaOfCircle = (radius) => {
  /* Write your code here */
  return parseFloat(((parseInt(radius))**2*Math.PI).toFixed(2))
